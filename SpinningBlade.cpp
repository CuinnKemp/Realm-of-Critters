...
void SpinningBlade::movement() {
  ...
  this->coordinates[0] = xpos - (200 * sin((3.14 / 200 * P1.level) * count));
  this->coordinates[1] = ypos - (200 * cos((3.14 / 200 * P1.level) * count));
  ...
  this->sprite.rotate((3.14 / 200 * P1.level) * 500);
